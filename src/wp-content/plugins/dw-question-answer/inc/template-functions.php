...
function dwqa_require_field_submit_question(){
	...
	<div class="user-email">
		<label for="user-email" title="<?php _e( 'Enter your email to receive notification regarding your question. Your email is safe with us and will not be published.','dwqa' ) ?>"><?php _e( 'Seu email *','dwqa' ) ?></label> 
		...
		<span><?php printf( __( 'ou faça o <strong><a href="%s">login</a></strong> para fazer uma pergunta', 'dwqa' ), wp_login_url( apply_filters( 'the_permalink', get_permalink( get_the_ID() ) ) ) ) ?></span>
	</div>
	<?php  }
}
