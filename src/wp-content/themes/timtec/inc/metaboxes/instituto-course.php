...
class add_instituto_course{

    protected static $metabox_config = array(
        'add_instituto_course',
    ...
    static function metabox(){
        ...
        if(!isset($metadata['instituto_course'])){
           $content = "";
        }else{
            $content = $metadata['instituto_course'][0];
        };
        ?>
        <input type="text" name="<?php echo __CLASS__ ?>[instituto_course]" value="<?php echo  $content; ?>" style="background-color: #fff; font-size: 1.7em; height: 1.7em; line-height: 100%; margin: 0; outline: 0; padding: 3px 8px; width: 100%;" />
        <?php
    }
