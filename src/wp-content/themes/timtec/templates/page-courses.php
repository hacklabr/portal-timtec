	...
	<section id="banner" class=" ">
		<div class="container">
			...
			<div class="col-md-12 text">
				<h4 >
					<?php  _oi("Lorem ipsum dolor sit amet, consectetur"); ?>
				</h4>   
			</div>
	...
	<section id="section1" class="">
		<div class="container">
			<div class="row text">
				...
				<p><?php  _oi("Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas
id velit lobortis, ultricies magna porta, molestie diam. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas id velit lobortis, ultricies magna porta, molestie diam."); ?></p>
	...
	<section id="section2" class="">
		<div class="container">
        	...
        	<div class="row text">
				<a href="#" class="btn_cadastrese"><?php  _oi("+ VEJA MAIS CURSOS"); ?></a>
			</div>
		</div><!-- /container-->
	</section>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-6 text">
					...
					<p><?php  _oi("Aprenda a montar seu próprio curso com a teconologia
de ponta do TIMTec. orem ipsum dolor sit amet, consectetur adipiscing elit. Maecen id velit lobortis, ultricies magna porta, molest.orem ipsum dolor sit amet, elit."); ?></p>
